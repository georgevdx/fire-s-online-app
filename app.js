...
function applyHomeRoleVisibility() {
  ...
  // Core inspection actions remain visible while access is loading.
  ...
  setHomeCommandCardVisible('cmdReportsBtn', isKnownRole && role !== 'guest');
  ...
  setHomeCommandCardVisible('cmdServicesBtn', isKnownRole && role !== 'guest');
