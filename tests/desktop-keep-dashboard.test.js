...
assert.ok(
  /fire-s-desktop-access\.js\?v=1-3-keep-dash/.test(liveHtml) &&
    /fire-s-startup-stability\.js\?v=1-11-splash/.test(liveHtml) &&
    /fire-s-management-dashboard\.js\?v=1-7-desktop/.test(liveHtml) &&
    /fire-s-get-started\.js\?v=2-47-splash/.test(liveHtml) &&
...
assert.ok(
  /fire-s-desktop-access\.js\?v=1-3-keep-dash/.test(stagingHtml) &&
    /fire-s-startup-stability\.js\?v=1-11-splash/.test(stagingHtml) &&
    /fire-s-management-dashboard\.js\?v=1-7-desktop/.test(stagingHtml) &&
    /fire-s-get-started\.js\?v=2-47-splash/.test(stagingHtml) &&
