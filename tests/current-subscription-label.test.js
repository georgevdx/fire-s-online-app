...
assert.ok(
  /fire-s-subscribe\.js\?v=1-34-php-sig/.test(read('staging/index.html')) &&
...
assert.ok(
  /Version 1\.3\.65/.test(read('index.html')) &&
    /Version 1\.3\.105-toets/.test(read('staging/index.html')),
  'Displayed versions stay 1.3.65 live and 1.3.105-toets'
);
