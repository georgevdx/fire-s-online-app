...
assert.ok(
  /fire-s-subscribe\.js\?v=1-23-company/.test(read('staging/index.html')) &&
...
assert.ok(
  /Version 1\.3\.65/.test(read('index.html')) &&
    /Version 1\.3\.94-toets/.test(read('staging/index.html')),
  'Displayed versions stay 1.3.65 live and 1.3.94-toets'
);
