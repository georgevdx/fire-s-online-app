...
assert.ok(
  /fire-s-subscribe\.js\?v=1-24-back-pay/.test(read('staging/index.html')) &&
...
assert.ok(
  /Version 1\.3\.65/.test(read('index.html')) &&
    /Version 1\.3\.95-toets/.test(read('staging/index.html')),
  'Displayed versions stay 1.3.65 live and 1.3.95-toets'
);
