...
const missingErr = new Error(
  'PayFast live is missing server secrets: PAYFAST_LIVE_MERCHANT_ID, PAYFAST_LIVE_MERCHANT_KEY, PAYFAST_LIVE_PASSPHRASE. Paste Merchant ID, Merchant Key and Salt Passphrase from www.payfast.co.za Settings → Integration into those names on the live Supabase project (ispsdmglyylcwkufphnv). Do not leave the Update box empty before Save.'
);
