...
assert.ok(
  /id="appVersion" class="brand-version">Version 1\.3\.72-toets</.test(html) &&
    /id="cloudVersion">1\.3\.72-toets</.test(html) &&
    /getElementById\('cloudVersion'\)/.test(env),
  'Toets-blad HTML must show 1.3.72-toets before scripts run'
);
assert.ok(
