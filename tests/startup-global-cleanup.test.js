...
assert.ok(
  /id="appVersion" class="brand-version">Version 1\.3\.112-toets</.test(html) &&
    /id="cloudVersion">1\.3\.112-toets</.test(html) &&
  ...
  'Toets-blad HTML must show 1.3.112-toets before scripts run'
);
assert.ok(
