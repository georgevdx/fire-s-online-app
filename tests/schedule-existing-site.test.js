...
assert.ok(
  /id="appVersion" class="brand-version">Version 1\.3\.66</.test(liveHtml) &&
    /id="cloudVersion">1\.3\.66</.test(liveHtml),
  'Live must show Version 1.3.66 in the header without waiting for a script'
);
assert.ok(
