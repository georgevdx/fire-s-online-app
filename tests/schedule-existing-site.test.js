...
assert.ok(
  /id="appVersion" class="brand-version">Version 1\.3\.83-toets</.test(stagingHtml) &&
    /id="cloudVersion">1\.3\.83-toets</.test(stagingHtml),
  'Toets-blad must show Version 1.3.83-toets in the header without waiting for a script'
);
