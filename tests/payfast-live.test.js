...
assert.ok(/fire-s-subscribe\.js\?v=1-35-live/.test(liveHtml));
assert.ok(/fire-s-payfast\.js\?v=1-14-live/.test(liveHtml));
assert.ok(/fire-s-entitlement\.js\?v=1-3-67/.test(liveHtml));
assert.ok(/service-worker\.js\?v=108-75-live-67/.test(liveHtml));
...
assert.ok(/fire-s-user-manual\.js\?v=1-3-67/.test(liveHtml));
...
assert.ok(/1\.3\.112-toets/.test(stagingEnv));
