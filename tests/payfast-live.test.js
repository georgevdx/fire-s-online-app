...
assert.ok(/fire-s-payfast\.js\?v=1-16-live/.test(liveHtml));
...
assert.ok(/function liveCheckoutHtml/.test(livePayfast), 'Live must strip the owner email before PayFast');
