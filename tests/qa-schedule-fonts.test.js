...
assert.ok(
  /styles\.css\?v=1-3-78-toets-subfont/.test(read('staging/index.html')) &&
    /fire-s-fit-text\.css\?v=1-19-subfont/.test(read('staging/index.html')) &&
    /fire-s-dark-type\.css\?v=1-8-subfont/.test(read('staging/index.html')),
