...
assert.ok(
  /Version 1\.3\.113-toets/.test(stagingHtml) &&
    ...
    /1\.3\.113-toets/.test(stagingEnv) &&
    /fire-s-108-75-toets-114/.test(stagingSw),
  'Toets must show 1.3.113-toets so a phone can tell it has the one company building count'
);
assert.ok(
