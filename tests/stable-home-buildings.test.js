...
assert.ok(
  /Version 1\.3\.109-toets/.test(stagingHtml) &&
    ...
    /1\.3\.109-toets/.test(stagingEnv) &&
    /fire-s-108-74-toets-109/.test(stagingSw),
  'Toets must show 1.3.109-toets so a phone can tell it has the one company building count'
);
assert.ok(
