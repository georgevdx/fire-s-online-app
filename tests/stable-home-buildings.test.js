...
assert.ok(
  /Version 1\.3\.115-toets/.test(stagingHtml) &&
    ...
    /1\.3\.115-toets/.test(stagingEnv) &&
    /fire-s-108-77-toets-clean/.test(stagingSw),
  'Toets must show 1.3.115-toets so a phone can tell it has the one company building count'
);
assert.ok(
