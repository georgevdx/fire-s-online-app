  ...
  function paintSubscribeForm() {
    ...
    if (guestNote) {
      guestNote.textContent = isStagingEnv()
        ...
        : 'Creates your owner login and this company name. One person is one company. If you already belong to a company, only that Owner can remove you. Then you can Subscribe here. You (the owner) pay R349 / month (or R3 490 / year) per email. Inspectors do not pay. Phone and desktop share that email. No card is taken yet.';
    }
  ...
  function showRegister() {
    ...
    setTitle(
      ...
      isStagingEnv()
        ...
        : 'You become the Owner of this company name. One person is one company. If you already belong to a company, only that Owner can remove you first. You pay R349 per email per month, or R3 490 per year. Inspectors do not pay. Next you manage personnel.'
    );
