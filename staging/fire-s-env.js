...
(function fireSEnv(root) {
  ...
  var env = {
    ...
    appVersion: staging ? '1.3.102-toets' : '1.3.27',
  ...
  function paintBanner() {
    ...
    if (stagingCloudReady) {
      bar.textContent =
        'TOETS-BLAD 1.3.102-toets — nie vir kliënte. Data sit in Fire-S Test, nie in die regte wolk nie.';
    } else {
      bar.textContent =
        'TOETS-BLAD 1.3.102-toets — nie vir kliënte. Die toets-wolk is nog nie gekoppel nie. Moenie hier Subscribe asof dit live is nie.';
    }
